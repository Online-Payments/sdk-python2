...
class CommunicatorTest(unittest.TestCase):
    ...
    def test_to_uri_without_request_parameters(self):
        ...
        communicator = Communicator(
            api_endpoint=urlparse("https://payment.preprod.online-payments.com"),
        ...
        self.assertEqual("https://payment.preprod.online-payments.com/v2/merchant/1/testconnection", uri1.geturl())
        self.assertEqual("https://payment.preprod.online-payments.com/v2/merchant/1/testconnection", uri2.geturl())
    ...
    def test_to_uri_with_request_parameters(self):
        ...
        self.assertEqual("https://payment.preprod.online-payments.com/v2/1/testconnection"
